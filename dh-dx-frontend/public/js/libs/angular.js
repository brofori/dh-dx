...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *
       * @param {string} name EventRequests name to listen on.
       ...
       *
       * @param {string} name EventRequests name to emit.
       * @param {...*} args Optional one or more arguments which will be passed onto the event listeners.
       * @return {Object} EventRequests object (see {@link ng.$rootScope.Scope#$on}).
       */
       ...
       * onto the {@link ng.$exceptionHandler $exceptionHandler} service.
       *
       * @param {string} name EventRequests name to broadcast.
       * @param {...*} args Optional one or more arguments which will be passed onto the event listeners.
       * @return {Object} EventRequests object, see {@link ng.$rootScope.Scope#$on}
       */
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   * @param {string} trigger EventRequests that triggered the update.
   */
